...
namespace Repuestos2023.DataLayer.Migrations
{
    ...
    [Migration("20231220172459_paypaltransaction")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repuestos2023.Models.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Repuestos2023.Models.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Repuestos2023.Models.Models.PayPalTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Repuestos2023.Models.Models.RepuestoProveedor", b =>
                {
                    b.Property<int>("RepuestoProveedorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RepuestoProveedorId"));
                    ...
                    b.HasKey("RepuestoProveedorId");

                    b.ToTable("RepuestosProveedores");
                });

            modelBuilder.Entity("Repuestos2023.Models.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Repuestos2023.Models.Models.OrderDetail", b =>
                {
                    b.HasOne("Repuestos2023.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Repuestos2023.Models.Models.Repuesto", "Repuesto")
                        .WithMany()
            ...
            modelBuilder.Entity("Repuestos2023.Models.Models.OrderHeader", b =>
                {
                    b.HasOne("Repuestos2023.Models.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
